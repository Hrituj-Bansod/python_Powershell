...
$num = Read-Host "
1. View all users present in the system.
2. View all groups present in the system.
3. Add a new user in the system.
4. Change the passsword of an existing user.
5. Rename the username of an existing user.
6. Delete a user from the system.
7. Add a new group in the system.
